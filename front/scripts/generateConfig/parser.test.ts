  ...
  const inputPool = [
    {
      ...
      sub_title: 'Online games on FANTOM',
      description:
  ...
  const inputFarm = [
    {
      ...
      pid: 0,
      lp_symbol: 'HTZ',
      lp_mainnet_address: '0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD',
      token: {
        _id: '5ffd7e79361bff0009cc8189',
        decimals: 18,
        name: 'SYRUP',
        symbol: 'SYRUP',
        mainnet_address: '0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD',
      ...
      quote_token: {
        ...
        name: 'FTM',
        symbol: 'FTM',
        mainnet_address: '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83',
    ...
    const outPut = [
      {
        ...
        address: '0x44a9Cc8463EC00937242b660BF65B10365d99baD',
        name: 'BLINk (BLK)',
        subTitle: 'Online games on FANTOM',
        description:
          'BLINk enables FTM holders to enjoy gaming experiences that WINk users on Tron have been enjoying for over two years.',
    ...
    const outPut = [
      {
        pid: 0,
        lpSymbol: 'HTZ',
        lpAddresses: '0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD',
        tokenSymbol: 'SYRUP',
        tokenAddresses: '0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD',
        quoteTokenSymbol: 'FTM',
        quoteTokenAdresses: '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83',
        multiplier: 1,
        isCommunity: false,
      },
    ]

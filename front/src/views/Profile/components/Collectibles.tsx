  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Hertz Token Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Hertz Token Collectibles are special ERC-721 NFTs that can be used on the Hertz Token platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Hertz Token Collectibles won't be shown here.",
        )}
      </Text>

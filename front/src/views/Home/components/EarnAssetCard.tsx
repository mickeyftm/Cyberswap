...
`
const EarnAssetCard = () => {
  const activeNonCakePools = pools.filter((pool) => pool.isBush && !pool.isFinished && !pool.tokenName.includes('HTZ'))
    ...
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <Flex justifyContent="space-between">
          <Heading size="lg">
            in <img src="/images/cyberswaptoken/bush.svg" height="24px" width="24px" alt="Launchpads" /> Launchpads
          </Heading>

  ...
  return (
    <StyledListedOn>
      <CardBody>
        ...
        <LinkListed>
          <a href="https://www.dapp.com/app/cyberswaptoken" target="_blank" rel="noreferrer">
            <Image
        ...
        <LinkListed>
          <a href="https://dappradar.com/binance-smart-chain/defi/cyberswaptoken" target="_blank" rel="noreferrer">
            <Image
        ...
        <LinkListed>
          <a href="https://www.bsc.news/bsc-projects" target="_blank" rel="noreferrer">
            <Image
              ...
              alt="The most recent news about Fantom Chain. Latest news about DeFi, Projects, Fantom blockchain, cryptocurrency prices and more."
              width={150}
              height={50}
            />
          </a>
        ...
        {/* <LinkListed>
          <a
            href="https://dex.apeswap.finance/#/swap?outputCurrency=0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD"
            target="_blank"
            rel="noreferrer"
          >
            <Image

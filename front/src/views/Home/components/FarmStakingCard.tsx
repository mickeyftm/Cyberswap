...
const FarmedStakingCard = () => {
  ...
  const tokenImageSrc = `${BASE_URL}/images/farms/htz.png`
  const tokenName = `HTZ`
  const tokenAddress = `0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD`
  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <Block>
          <Label>{TranslateString(544, 'HTZ to Harvest')}:</Label>
          <CakeHarvestBalance />
        </Block>
        <Block>
          <Label>{TranslateString(546, 'HTZ in Wallet')}:</Label>
          <CakeWalletBalance />
        </Block>
        <Actions>
          {account ? (
            ...
            >
              {pendingTx
                ? TranslateString(548, 'Collecting HTZ')
        ...
        <Block>
          ...
          <TertiaryButton variant="primary" scale="sm" width="100%">
            <LinkExternal href="https://ftmscan.com/token/0x68F7880F7af43a81bEf25E2aE83802Eb6c2DdBFD" color="#ffffff">

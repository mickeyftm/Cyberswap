...
const Nfts: Nft[] = [
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master HTZ chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of HTZ.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's HTZ)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
  ...
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping pancakes. Especially on FANTOM.',
    images: {
      lg: 'swapsies-lg.png',
      md: 'swapsies-md.png',
      sm: 'swapsies-sm.png',
